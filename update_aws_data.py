...
for i in fac:
    ...
    while True:
        ...
        # Insert 쿼리
        sql = "INSERT INTO wss_aws_data(obsr_Spot_Code, obsr_Spot_Nm, date_Time, tmprt_150, tmprt_150Top, tmprt_150Lwet, tmprt_50, tmprt_50Top, tmprt_50Lwet, tmprt_400, tmprt_400Top, tmprt_400Lwet, hd_150, hd_50, hd_400, wd_300, wd_150, wd_1000, arvlty_300, arvlty_150, arvlty_1000, afp, afv, sunshn_Time, solrad_Qy, dwcn_Time, pnwg_Tp, frfr_Tp, udgr_Heatt_Cndctvt, udgr_Tp_10, udgr_Tp_5, udgr_Tp_20, soil_Mitr_10, soil_Mitr_10Cmst, soil_Mitr_20, soil_Mitr_20Cmst, soil_Mitr_30, soil_Mitr_30Cmst) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"

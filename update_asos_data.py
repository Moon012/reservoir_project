...
for i in observatory:
    ...
    try:
        ...
        # Insert 쿼리
        sql = "INSERT INTO wss_asos_data(stnid, stnnm, tm, avgta, minta, mintahrmt, maxta, maxtahrmt, mi10maxrn, mi10maxrnhrmt, hr1maxrn, hr1maxrnhrmt, sumrndur, sumrn, maxinsws, maxinswswd, maxinswshrmt, maxws, maxwswd, maxwshrmt, avgws, hr24sumrws, maxwd, avgtd, minrhm, minrhmhrmt, avgrhm, avgpv, avgpa, maxps, maxpshrmt, minps, minpshrmt, avgps, ssdur, sumsshr, hr1maxicsrhrmt, hr1maxicsr, sumgsr, ddmefs, ddmefshrmt, ddmes, ddmeshrmt, sumdpthfhsc, avgtca, avglmac, avgts, mintg, avgcm5te, avgcm10te, avgcm20te, avgcm30te, avgm05te, avgm10te, avgm15te, avgm30te, avgm50te, sumlrgev, sumsmlev, n99rn, iscs, sumfogdur) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s) ON CONFLICT ON CONSTRAINT pk_wss_asos_data DO NOTHING "
